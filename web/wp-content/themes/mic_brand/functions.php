...
if ( ! function_exists( 'brand_setup' ) ) :
	...
	function brand_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'brand' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'brand_custom_background_args', array(
...
function brand_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'brand_content_width', 640 );
}
...
function brand_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'brand' ),
...
function brand_scripts() {
	...
	wp_enqueue_script( 'brand-custom-js', get_template_directory_uri() . '/js/dist/app.js', array(), '20151215', true );

	wp_enqueue_script( 'brand-navigation', get_template_directory_uri() . '/js/vendor/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'brand-skip-link-focus-fix', get_template_directory_uri() . '/js/vendor/skip-link-focus-fix.js', array(), '20151215', true );
